function I18NClass()
{
	...
	// desc : change the page text of the tag elements which have self attribute
	// according to the languagePageObject
	// parameter
	// [IN] languagePageObject: language define page json object, which defines
	// language string for the self tag
	...
	// desc : change the html elements which has specified "self" attribute with
	// the languagePageObject
	// parameter
	// [IN] languagePageObject: language define page json object, which defines
	// language string for the self tag
	// return :
